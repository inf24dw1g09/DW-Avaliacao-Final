...
export class PostsCommentsController {
  ...
  async find(
    ...
    return this.postsRepository.post_comment(id).find();
  }
  ...
  async create(
    ...
    return this.postsRepository.post_comment(id).create(comments);
  }
  ...
  async patch(
    ...
    return this.postsRepository.post_comment(id).patch(comments, where);
  }
  ...
  async delete(
    ...
    return this.postsRepository.post_comment(id).delete(where);
  }
}
