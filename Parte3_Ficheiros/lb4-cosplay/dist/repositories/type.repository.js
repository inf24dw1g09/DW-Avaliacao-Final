...
let TypeRepository = class TypeRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource) {
        super(models_1.Type, dataSource);
    }
};
exports.TypeRepository = TypeRepository;
exports.TypeRepository = TypeRepository = tslib_1.__decorate([
